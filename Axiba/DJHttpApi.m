...
{
//    NSString *Url = [NSString stringWithFormat:@"%@%@",_host_,URLString];
...
//    NSString *Url = [NSString stringWithFormat:@"http://192.168.1.78:8095%@",URLString];
...
- (void)POSTAD:(NSString *)URLString dict:(id)dict succeed:(void (^)(id data))succeed failure:(void (^)(NSError *error))failure
{
    
    //     NSString *Url = [NSString stringWithFormat:@"%@%@",_host_,URLString];
    
    NSString *Url = [NSString stringWithFormat:@"http://www.xxeden.com:8080%@",URLString];
