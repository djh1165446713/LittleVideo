...
//
//  OmoShareDjhManaage.m
//  Axiba
//
//  Created by bianKerMacBook on 2017/4/19.
...
@interface OmoShareDjhManaage()<UMSocialUIDelegate>
{
    WMPlayer *ui_player;
...
@implementation OmoShareDjhManaage
@synthesize blockShareResult;


+ (OmoShareDjhManaage *)shareInstance
{
    static OmoShareDjhManaage * commonViewManager = nil;
    if(commonViewManager == nil)
    {
        commonViewManager = [[OmoShareDjhManaage alloc]init];
    }
                ...
                block:(BlockResultState)_block
{
    ...
    NSArray *arraySns = [_contentids isValid] ? @[UMShareToWechatSession,UMShareToWechatTimeline,UMShareToSina,UMShareToQQ,UMShareToQzone,UMShareToEmail] :@[UMShareToWechatSession,UMShareToWechatTimeline,UMShareToSina,UMShareToQQ,UMShareToQzone];
